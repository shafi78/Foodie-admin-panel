...
const Ordersection = () => {
    ...
    const getallorder = async() => {
        const data = await getDocs(collection(db, "Userorders"));
  ...
  return (
    <div className='order-section'>
        ...
        <div className='order-s1'>
            <input type="text" placeholder='Search by order id or delivery status' className='searchbar' onChange={(e) => setKeyword(e.target.value)} />
            <div className="s1in">
                <p>Sort by order status</p>
                <select name="" id="" className='ordertxt'  onChange={(e) => setAllOrderStatus(e.target.value)}>
        ...
        <div className='order__container'>
            <div className="order-row_card1">
                <p className="ordertxt">Order Id</p>
            ...
            <div className="order__container">
                ...
                return (
                    ...
                    {order.deliveryboy_phone ? <p className='ordertxt'>{order.deliveryboy_phone}</p> :
                     <input type="number" placeholder='Enter Deliveryboy phone' className='orderinput' onBlur={(e) => changeDeliveryboyPhone(order.orderid,order,e.target.value)} /> }
